...
class MainHandlers:
    ...
    def district(self, update: Update, context: CallbackContext):
        ...
        if district:
            ...
            context.user_data['tmp_message'] = user.send_message(i18n("shop_location",lang), reply_markup=ReplyKeyboardMarkup([[KeyboardButton(i18n('request_location', lang))]]), parse_mode="HTML")
