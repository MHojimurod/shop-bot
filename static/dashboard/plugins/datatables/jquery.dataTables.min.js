...
(function (h) {
  ...
  l.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "Ҳозирча диллерлар ёъқ",
      sInfo: "Натижалар _START_ - _END_    _TOTAL_ дан",
      sInfoEmpty: "Натижалар 0 - 0    0 дан",
      sInfoFiltered: "( _MAX_ умумий )",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      ...
      sSearch: "Қидирув:",
      sSearchPlaceholder: "қидирув",
      sUrl: "",
      sZeroRecords: "Афсус ҳеч қандай маълумот топилмади",
    },
